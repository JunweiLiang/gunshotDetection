...
#   Module  :  Makefile
#   Date    :  $Id: Makefile 3258 2010-05-26 19:23:20Z metze $
#
...
ifeq ($(SYSTEM), Darwin)
    ...
    LDOpts     = -L/Developer/SDKs/MacOSX10.5.sdk/usr/lib -L/Developer/SDKs/MacOSX10.5.sdk/usr/X11/lib -L$(HOME)/Work/portaudio/lib/.libs
    LOCALLIBS += -lreadline -lportaudio -lcblas -latlas
# -lgomp
    ...
    OptFlags     = -O3 -ffast-math -fomit-frame-pointer -msse3 -funsafe-math-optimizations -funroll-loops -ftree-vectorize
...
# -fopenmp
    ...
    PrfFlags	 = -O3 -ffast-math -march=x86-64 -msse3 -funsafe-math-optimizations -funroll-loops -ftree-vectorize -pg
    LDPrfFlags	 = -pg
...
ifeq ($(SYSTEM), Linux)
    ...
    LOCALCFLAGS	 = -D__USE_GNU -DLINUX -DUSE_COMPAT_CONST -DSPHERE -DBLAS -DCMUJRTK -DSSE_OPT -DMTHREAD
...
# -L$(HOME)/janus-roger/src/cplusplus -L$(HOME)/janus-roger/src/LSA -L/data/ASR2/Mandarin/Wilson.Wiki/Software/srilm/lib/x86_64
    else
	LDOpts	 = -L/usr/X11R6/lib -L$(HOME)/tools/Sphere/lib
    endif

    LOCALLIBS	+= -lreadline -lsp -lsputil -lcblas -laegis -llapack_Linux_XEONSSE3_4 -lcblaswr -lF77 -llapack -lcblas -latlas -lstdc++ -lnrc -lgomp -lpthread -lm
# -lcblas -llapack
# -lportaudio -lsndfile
# -lpthread
# -lgomp
...
# -I$(HOME)/janus-roger/src/LSA -I$(HOME)/janus-roger/src/cplusplus
...
# -------------------- options for GCC
	...
	ifeq ($(MACH), x86_64)
	    OptFlags     = -O3 -ffast-math -fomit-frame-pointer -fno-strict-aliasing -march=x86-64 -msse3 -funsafe-math-optimizations -funroll-loops -ftree-vectorize
# -fopenmp
# -ftree-vectorizer-verbose=5
	else
