...
#Define global paths
PathToBinaries = "/data/MM3/srawat/MFCC_Extraction_Pipeline/Stack5/"
PathTotxyc = "java -Xmx1000m -cp "+ os.path.join(PathToBinaries,"bof.jar") + " txyc"
PathTobof = "java -Xmx1000m -cp " + os.path.join(PathToBinaries,"bof.jar") + " bof"
